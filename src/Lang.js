...
1.以推荐码作推荐链接关系。
2.静态收益 ：
    为合约地址币数总量的三十分之一加权分配，确保了该智能合约财富永久运行，享受首条匿名公链的财富盛宴。而单个帐户的  当天静态返还=个人当前未返还总数÷全网当前未返还总数×当天返还总数；另外单个帐户日最高释放量为预计总收益的千分之二，超出部分会继续返回合约池继续分配。 
    玩家参与条件： 
    A级：10≤X＜1000 SERO 静+动态奖3倍出局 ；
    B级：1000≤X＜5000个SERO 静+动态奖4倍出局； 
    C级：5000≤X<50000个SERO静+动态奖5倍出局；
    D级：50000个SERO及以上静+动态奖6倍出局；
    可原点位复投加单。 （备注：预计总收益=实际投资额x相应倍数） 

3.分享收益：
    a）永久享受第一代被分享人新增业绩的10%、第二代的7％
    b）直接分享业绩达5万SERO，可享受第三代被分享人新增业绩的1% ，依此类推直接分享业绩每增加1万SERO，可增加享受多1层被分享人新增业绩的1%，最高可享受12代。
    c）直接分享累计业绩未达到b描述条件时，投资额累计达到10万及10万以上SERO也可以直接领取12代内每层新增业绩的1%。
    d）分享收益每日结算，可提现可复投。
 
4.管理奖:
    除去最大业绩部门之外， 其它所有业绩相加计算。
    级别 业绩 收益
    一星 除最大直推部门业绩外，其余所有直推部门业绩总和10万 SERO 分享伞下新增业绩3%、平级拿新增业绩1% 
    二星 除最大直推部门业绩外，其余所有直推部门业绩总和50万 SERO 分享伞下新增业绩6%、平级拿新增业绩1% 
    三星 除最大直推部门业绩外，其余所有直推部门业绩总和150万SERO 分享伞下新增业绩9%、平级拿新增业绩1% 
    四星 除最大直推部门业绩外，其余所有直推部门业绩总和300万SERO 分享伞下新增业绩12%、平级拿新增业绩1％
 特别奖励奖 4星⭐  平级前4位；除最大直推部门业绩总和500万SERO分享伞下新增业绩1％
(备注：分享收益、平级收益即时结算，有级差、有烧伤；平级奖指的是同部门出现第一个平级的时候，依然可以拿它网体下新增业绩对应星级收益，直到同部门中出现新的平级，则平级奖由倒数第二个平级者获得）星级之间有烧伤。

5.技术占股6% 
6.系统开源，数据上链，代码写定，去中心化记账，没有后门，不可篡改，自动运行，自动分发。
7.系统公开合约规则及默认推荐码，玩家可在无推荐人的情况下主动参与。
8.开源代码查询地址：https://gitee.com/aldl/aldl
9.推荐码:5H44HVAD  `,
        }
    };
