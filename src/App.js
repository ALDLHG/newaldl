        ...
        staticTotal() {
            ...
            setTimeout(function () {
                ...
                if (times > 0) {
                    ...
                    if (parseFloat(that.state.amount) >= 10 && parseFloat(that.state.amount) < 1000) {
                        estimateLevel = 3
                    } else if (parseFloat(that.state.amount) >= 1000 && parseFloat(that.state.amount) < 5000) {
                        estimateLevel = 4
                    } else if (parseFloat(that.state.amount) >= 5000 && parseFloat(that.state.amount) < 50000) {
                        estimateLevel = 5
                    }else if (parseFloat(that.state.amount) >= 50000) {
                        estimateLevel = 6
                    }
                }
